...
export function RPProfile() {
  ...
  const handleCopyLink = () => {
    const publicUrl = formData.username ? `http://localhost:3000/guest/${formData.username}` : '';
    if (publicUrl) {
      ...
      <GlassCard className="p-6 lg:p-8">
            ...
            <div className="relative">
              ...
              >
                {formData.profile_image_url ? (
                  <img
                    src={`/api/serve-image?file=${formData.profile_image_url}`}
                    alt={user.name}
        ...
        <div className="mb-6">
          ...
          >
            ...
            <input
              type="text"
              value={formData.username ? `http://localhost:3000/guest/${formData.username}` : 'Defina um username primeiro'}
              readOnly
